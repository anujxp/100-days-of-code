...
abstract class Employee {
    String name; public Employee(String name){this.name=name;}
    abstract double monthlyPay();
    public String getName(){return name;}
}
class SalariedEmployee extends Employee implements Payable {
    double salary; public SalariedEmployee(String name,double salary){super(name);this.salary=salary;}
    @Override public double monthlyPay(){ return salary/12.0; }
    @Override public double pay(){ return monthlyPay(); }
}
